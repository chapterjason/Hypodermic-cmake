            ...
            struct ConstructorTypologyDeducer
                    <
                            ...
                            typename std::enable_if
                                    <
                                            (Cardinality<NthArgument...>::value > 0 &&
                                             Cardinality<NthArgument...>::value <
                                             HYPODERMIC_CONSTRUCTOR_ARGUMENT_COUNT) &&
            ...
            struct ConstructorTypologyDeducer
                    <
                            ...
                            typename std::enable_if<
                                    ...
                                    std::is_constructible<T, WrapAndGet<T, NthArgument>...>::value>::type
                    > : Utils::ArgumentPack<WrapAndGet<T, NthArgument>...> {
            };
