...
#include "AutowireableConstructorRegistrationDescriptor.hpp"
#include "ProvidedInstanceFactoryRegistrationDescriptor.hpp"
#include "ProvidedInstanceRegistrationDescriptor.hpp"
...
namespace Hypodermic {
    ...
    namespace RegistrationDescriptorBuilder {
        ...
        struct ForTypeConstruction {
            static_assert(Traits::HasAutowireableConstructor<T>::value,
                          "Could not autowire T: you should consider registering T either by providing an instance or an instance factory");
        ...
        struct ForProvidedInstanceFactory {
            ...
            public:
                static_assert(IsInvokableWithContainer<TCallable>::value,
                              "TCallable should have an invokable function which signature matches std::shared_ptr< T >(ComponentContext&)");
