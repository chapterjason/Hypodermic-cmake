    ...
    namespace RegistrationDescriptorOperations {
        ...
        class OnActivated {
            ...
            public:
                ...
                TDelayedDescriptor &onActivated(const std::function<void(ComponentContext &,
                                                                         const std::shared_ptr <InstanceType> &)> &handler) {
                    auto descriptor = static_cast< TDescriptor * >(this);
                    descriptor->addActivationHandler(
                            [handler](ComponentContext &componentContext, const std::shared_ptr<void> &instance) {
