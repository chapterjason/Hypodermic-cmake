...
#include "RegistrationActivator.hpp"
    ...
    class Registration : public IRegistration {
        public:
            Registration(const TypeInfo &instanceType,
                         ...
                         bool isFallback)
                    : m_activator(*this, instanceFactory, activationHandlers), m_instanceType(instanceType),
                      m_typeAliases(typeAliases), m_dependencyFactories(dependencyFactories), m_isFallback(isFallback) {
            }
