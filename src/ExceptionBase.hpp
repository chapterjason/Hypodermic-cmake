    ...
    class ExceptionBase : public std::exception {
        public:
            explicit ExceptionBase(std::string message = std::string(),
                                   ...
                                   std::string file = std::string(),
                                   int line = -1)
                    : std::exception(), m_message(std::move(message)), m_innerException(),
                      m_function(std::move(function)), m_file(std::move(file)), m_line(line), m_wholeMessage() {
            }
            ...
            explicit ExceptionBase(std::exception innerException,
                                   ...
                                   std::string file = std::string(),
                                   int line = -1)
                    : std::exception(), m_message(), m_innerException(std::move(innerException)),
                      m_function(std::move(function)), m_file(std::move(file)), m_line(line), m_wholeMessage() {
            }
            ...
            explicit ExceptionBase(std::string message,
                                   ...
                                   std::string file = std::string(),
                                   int line = -1)
                    : std::exception(), m_message(std::move(message)), m_innerException(std::move(innerException)),
                      m_function(std::move(function)), m_file(std::move(file)), m_line(line), m_wholeMessage() {
            }
