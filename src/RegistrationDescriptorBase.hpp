...
#include "IRegistrationDescriptor.hpp"
#include "RegistrationDescriptorInfo.hpp"
    ...
    class RegistrationDescriptorBase : public IRegistrationDescriptor {
        public:
            RegistrationDescriptorBase(const TypeInfo &instanceType,
                    ...
                    : m_instanceType(instanceType), m_typeAliases(typeAliases),
                      m_dependencyFactories(dependencyFactories), m_activationHandlers(activationHandlers) {
            }
        ...
        protected:
            ...
            void addTypeIfMissing(const TypeAliasKey &typeAliasKey, const std::function<std::shared_ptr<void>(
                    const std::shared_ptr<void> &)> &alignPointersFunc) {
