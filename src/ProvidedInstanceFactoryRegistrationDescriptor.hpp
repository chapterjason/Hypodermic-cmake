...
#include "Log.hpp"
#include "Named.hpp"
#include "OnActivated.hpp"
#include "RegistrationBuilder.hpp"
#include "RegistrationDescriptorBase.hpp"
#include "SingleInstance.hpp"
#include "UseIfNone.hpp"

namespace Hypodermic {

    template<class TDescriptorInfo>
    class ProvidedInstanceFactoryRegistrationDescriptor
            : public RegistrationDescriptorBase<ProvidedInstanceFactoryRegistrationDescriptor<TDescriptorInfo>, TDescriptorInfo>,
        ...
        public:
            explicit ProvidedInstanceFactoryRegistrationDescriptor(
                    const std::function<std::shared_ptr<InstanceType>(ComponentContext &)> &instanceFactory)
                    : BaseType(Utils::getMetaTypeInfo<InstanceType>()), m_instanceFactory(instanceFactory) {
            }
            ...
            ProvidedInstanceFactoryRegistrationDescriptor(const TypeInfo &instanceType,
                                                          ...
                                                          const std::function<std::shared_ptr<InstanceType>(
                                                                  ComponentContext &)> &instanceFactory)
